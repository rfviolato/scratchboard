...
const buttonIconVariants: Record<string, Variant> = {
  initial: { opacity: 0, scale: 0.5, filter: "blur(1px)" },
  animate: { opacity: 1, scale: 1, filter: "blur(0)" },
  exit: { opacity: 0, scale: 0.5, filter: "blur(1px)" },
};

const numbersVariant: Record<string, Variant> = {
